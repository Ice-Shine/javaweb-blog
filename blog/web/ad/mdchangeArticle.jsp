        ...
        <div class="container" style="width: 1000px;" >
            <form action="${pageContext.request.contextPath}/mdAdArticleServlet" method="post">
                <div class="form-group">
                    ...
                    <br/>
<%--
                    <input type="text" name="user_id" class="form-control" id="user_id" placeholder="请输入用户名ID" value=""/>
--%>
                    <select class="selectuser" name="user_id">
                        <c:forEach items="${user}" var="id" varStatus="s">
